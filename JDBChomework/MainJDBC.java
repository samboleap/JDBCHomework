            ...
            switch (option){
                case 1 :
                    ...
                    do {
                        ...
                        jdbcMethod.setEmail(scanner.next());
                        System.out.println("Enter Password:");
                        jdbcMethod.setPwd(scanner.next());

                        try {
                            String insert =  "INSERT INTO HomeworkJDBC (id ,username, description,email ,pwd )VALUES(?,?,?,?,?)";
                            ...
                            statement.setString(4,jdbcMethod.getEmail());
                            statement.setString(5, jdbcMethod.getPwd());
                        ...
                        switch (option){
                            case 1 :
                                ...
                                try {
                                    ...
                                    String newID = "";
                                    String updateID = "UPDATE HomeworkJDBC set id = '" + newID +"'WHERE id = '" +jdbcMethod.getId()+"'";
                            ...
                            case 2:
                                ...
                                try {
                                    ...
                                    String newUSERNAME = "";
                                    String updateUSER = "UPDATE HomeworkJDBC set username = '" + newUSERNAME +"'WHERE username = '" +jdbcMethod.getUsername()+"'";
                            ...
                            case 3:
                                ...
                                try {
                                    ...
                                    String newEMAIL = "";
                                    String updateEMAIL = "UPDATE HomeworkJDBC set email = '" + newEMAIL +"'WHERE email = '" +jdbcMethod.getEmail()+"'";
                                    int upEMAIL = statement4.executeUpdate(updateEMAIL);
                                    if (upEMAIL > 0){
                                        isUpdateValid = true;
                                        System.out.println("Email Successfully Updated");}
                                    else
                                        System.out.println("Retry To Update Email Later!!!");
                                } catch (SQLException e) {
                                    e.printStackTrace();
                                }
                            case 4:
                                ...
                                try {
                                    ...
                                    String newPWD = "";
                                    String updatePWD = "UPDATE HomeworkJDBC set pwd = '" + newPWD +"'WHERE pwd = '" +jdbcMethod.getPwd()+"'";
                                    int upPWD = statement5.executeUpdate(updatePWD);
                                    if (upPWD > 0){
                                        isUpdateValid = true;
                                        System.out.println("Password Successfully Updated");}
                                    else
                                        System.out.println("Retry To Update Password Later!!!");
                                } catch (SQLException e) {
                                    e.printStackTrace();
                                }
                            case 5:
                        ...
                        switch (option){
                            case 1:
                                ...
                                try {
                                    ...
                                    String deleteID = "DELETE from HomeworkJDBC WHERE id = '" + jdbcMethod.getId() +
                                            "' pwd = '" + jdbcMethod.getPwd() + "' email = '" +jdbcMethod.getEmail()+
                            ...
                            case 2:
                                ...
                                try {
                                    ...
                                    String deleteID = "DELETE from HomeworkJDBC WHERE username = '" + jdbcMethod.getUsername() +
                                            "' pwd = '" + jdbcMethod.getPwd() + "' email = '" +jdbcMethod.getEmail()+
                        ...
                        switch (option){
                            case 1:
                                ...
                                try {
                                    ...
                                    String selectID = "SELECT * FROM HomeworkJDBC WHERE id = '"+jdbcMethod.getId()+"'";
                            ...
                            case 2:
                                ...
                                try {
                                    ...
                                    String selectUSER = "SELECT * FROM HomeworkJDBC WHERE username = '"+jdbcMethod.getId()+"'";
                            ...
                            case 3:
                                ...
                                try {
                                    String selectALL = "SELECT * FROM HomeworkJDBC ";
                                    ...
                                    if (rs.next()) {
                                        ...
                                        jdbcMethodList.add(new JDBCMethod(id,username,description,email,pwd));
